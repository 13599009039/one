...
const CHINA_REGIONS = {
    ...
    '江苏省': {
        ...
        '淮安市': ['清江浦区', '淮阴区', '淮安区', '涂阳区', '金湖县'],
        '盐城市': ['亭湖区', '盐都区', '大丰区', '响水区', '滨海县', '阜宁县', '射阳县', '建湖县', '东台市'],
    ...
    '山东省': {
        ...
        '淮坊市': ['淄川区', '张店区', '淄博山区', '周村区', '桓台县'],
        '东营市': ['东营区', '河口区', '垃利区', '广饶区', '利津县'],
        '济宁市': ['任城区', '兖州区', '微山县', '鱼台县', '金乡县', '嘉祥县', '汶上县', '泗水县', '梁山县', '曲阜市', '邹城市'],
        '泰安市': ['泰山区', '岱岳区', '宁阳县', '东平县', '新泰市', '肥城市'],
        '威海市': ['环翠区', '文登区', '荣成市', '乳山市'],
        '日照市': ['东港区', '岚山区', '五莲县', '莒县'],
        '滨州市': ['滨城区', '沿河区', '惠民县', '阳信县', '无棣县', '博兴县', '邹平市'],
        '德州市': ['德城区', '陵城区', '宁津县', '庆云县', '临邑县', '齐河县', '平原县', '夏津县', '武城县', '乐陵市', '禹城市'],
        '聊城市': ['东昌府区', '茂县', '东阿县', '冠县', '阳谷县', '临清市', '高唐市'],
        '菏泽市': ['牡丹区', '定陶区', '曹县', '单县', '成武县', '巨野县', '郓县', '鄄城县', '东明县']
    },
    '河南省': {
        ...
        '平顶山市': ['卫东区', '石龙区', '湛河区', '宝丰区', '舍县', '鲁山县', '叶县', '郏县', '汝州市'],
        '安阳市': ['文峰区', '北关区', '殷都区', '龙安区', '汤阴县', '滑县', '内黄县', '林州市'],
        '鹤壁市': ['鹤山区', '山城区', '淇县', '浚县'],
        '新乡市': ['红旗区', '卫滨区', '凤泉区', '牧野区', '新乡县', '获嘉县', '原阳县', '延津县', '封丘县', '长垣市', '卫辉市', '辉县市'],
        '焦作市': ['解放区', '中站区', '马村区', '山阳区', '修武县', '博爱县', '沁阳县', '温县', '武陟县', '孟州市'],
        '濮阳市': ['华龙区', '清丰县', '南乐县', '范县', '台前县', '濮阳县'],
        '许昌市': ['魏都区', '建安区', '鄢陵区', '襄城县', '许昌县', '长葛市'],
        '漯河市': ['源汇区', '郾城区', '召陵区', '舞阳县', '临颍县'],
        '三门峡市': ['湖滨区', '陕州区', '渑池县', '卢氏县', '义马市', '灵宝市'],
        '南阳市': ['宛城区', '卧龙区', '南召区', '方城区', '邓州区', '新野县', '唐河县', '桐柏县', '淅川县', '镇平县', '内乡县', '西峡县', '社旗县'],
        '商丘市': ['梁园区', '睢阳区', '民权县', '睢县', '宁陵县', '柘城县', '虞城县', '夏邑县', '永城市'],
        '信阳市': ['浉河区', '平桥区', '罗山县', '光山县', '新县', '商城县', '固始县', '潢川县', '息县', '淮滨市'],
        '周口市': ['川汇区', '涮阳区', '扶沟县', '西华县', '商水县', '沈丘县', '郸城县', '淮阳县', '太康县', '鹿邑县'],
        '驻马店市': ['驿城区', '西平县', '上蔡县', '平舆县', '正阳县', '确山县', '泗水县', '汝南县', '遂平县', '新蔡县']
    },
    '湖北省': {
        ...
        '荆州市': ['沙市区', '荆州区', '公安县', '监利县', '洪湖市', '石首市'],
        '十堰市': ['茅箭区', '张湾区', '郧西区', '郧县', '竹山县', '房县', '竹溪县', '丰都市'],
        '黄冈市': ['黄州区', '黄港区', '黄梅区', '黄陂区', '蓕春县', '浪川市', '麻城市', '武穴市', '英山县', '罗田县'],
        '孝感市': ['孝南区', '孝昌区', '大悍县', '孝昌县', '云梦县', '应城市', '安陆市'],
        '咸宁市': ['咸安区', '嘉鱼区', '赤壁市', '通城县', '崇阳县', '通山县'],
        '随州市': ['曾都区', '随县', '广水市'],
    ...
    '湖南省': {
        ...
        '衡阳市': ['珠晖区', '雁峰区', '石鼓区', '蒸湘区', '南岳区', '衡阳县', '衡南县', '衡山县', '耒东县', '祁东县', '常宁市', '耶阳市'],
        ...
        '郴州市': ['北湖区', '苏仙区', '桂阳县', '宜章县', '永兴县', '嘉禾县', '临武县', '汝县', '桂东县', '安仁县', '资兴市'],
        '永州市': ['零陵区', '冷水滩区', '祁阳县', '东安县', '双牌县', '道县', '江永县', '宁远县', '蓝山县', '新田县', '江华瑶族自治县'],
        '怀化市': ['鹤城区', '中方县', '沅陵县', '辰溪县', '靖州苗族侗族自治县', '会同县', '麻阳苗族自治县', '新晃侗族自治县', '芷江侗族自治县', '靖州侗族苗族自治县', '通道侗族自治县', '洪江市'],
        '娄底市': ['娄星区', '双峰县', '新化县', '冷水江市', '涟源县'],
